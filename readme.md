...
4. [Domain Class Diagram v1](docs/design/domain-class-diagram-v1.md) ([mở bản draw.io](docs/design/domain-class-diagram-v1.drawio)) — lớp đối tượng, quan hệ nghiệp vụ và ranh giới Backend.
